    ...
    return (
      <div className="FightBox">
        <div class="scroll-box">
          <p>
            <h3 className="round">Round: {props.round}</h3>
            <h2 className="enemy">{props.enemy}</h2>
            <h4 className="one">{props.pDmg}</h4>
            <h4 className="two">{props.mDmg}</h4>
            <div className="theon">
            <h5 className="theonOne">{props.pName}'s HP: {props.pHP}</h5>
            <h5 className="theonTwo">{props.monster[props.killed].name}'s HP: {props.mHP}</h5>
            </div>
            <h2 className="win">{props.win}</h2>
